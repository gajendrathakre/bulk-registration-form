...
if(isset($_POST['submit'])){
    ...
    $insertquery= "insert into usersdata(name,date,email,mobile,gender,occupation,idtype,idnumber,issued,issuestate,issuedate,expdate,addresstype,nationality,state,district,blocknumber,ward,fathername,mothername,grandfather,spousename,fatherinlaw,motherinlaw) values ('$name','$date','$email','$mobile','$gender','$occupation','$idtype','$idnumber','$issued','$issuestate','$issuedate','$expdate','$addresstype','$nationality','$state','$district','$blocknumber','$ward','$fathername','$mothername','$grandfather','$spousename','$fatherinlaw','$motherinlaw')";
                ...
                <div class="details ID">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="issued" placeholder="Enter issued authority" required>
                        </div>

                        <div class="input-field">
                            <label>Issued State</label>
                            <input type="text" name="issuestate" placeholder="Enter issued state" required>
                        </div>
                        ...
                        <div class="input-field">
                            ...
                            <input type="date" name="expdate" placeholder="Enter expiry date" required>
                        </div>
                    </div>
                ...
                <div class="details address">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="blocknumber" placeholder="Enter block number" required>
                        </div>
                ...
                <div class="details family">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="grandfather" placeholder="Enter grandfther name" required>
                        </div>

                        <div class="input-field">
                            <label>Spouse Name</label>
                            <input type="text" name="spousename" placeholder="Enter spouse name" required>
                        </div>

                        <div class="input-field">
                            <label>Father in Law</label>
                            <input type="text" name="fatherinlaw" placeholder="Father in law name" required>
                        </div>

                        <div class="input-field">
                            <label>Mother in Law</label>
                            <input type="text" name="motherinlaw" placeholder="Mother in law name" required>
                        </div>
                    </div>
                    ...
                    <!--<button class="sumbit">
                       <input class="btnText" type="submit" name="submit" value="Submit" />
                        ...
                        <button class="sumbit" name="submit" type="submit">
